...
I started by loading the the labeled data for vehicle and non-vehicle examples provided on the class instructions in cells `[3]` through `[5]` of the [Ipython notebook](Vehicle%20Detection%20Project.ipynb). These images are collected into a numpy array `X` and 
